...
See more information in <a href="https://github.com/organization/projectname#seg">module documentation</a>.
"""
...
def registerSampleData():
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        thumbnailFileName=os.path.join(iconsPath, 'seg1.png'),
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        category='seg',
        sampleName='seg2',
        thumbnailFileName=os.path.join(iconsPath, 'seg2.png'),
        # Download URL and target file name
...
class segLogic(ScriptedLoadableModuleLogic):
    ...
    def process(self, inputVolume, outputVolume, imageThreshold, invert=False, showResult=True):
        ...
        volumeNode = slicer.util.arrayFromVolume(volumeNode)
        ...
        masterVolumeNode = slicer.util.getNode('MRHead cropped')
...
class segTest(ScriptedLoadableModuleTest):
    ...
    def test_seg1(self):
        ...
        import SampleData
        registerSampleData()
        inputVolume = SampleData.downloadSample('seg1')
