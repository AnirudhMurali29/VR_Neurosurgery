...
class point_marking(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = "point_marking"  # TODO: make this more human readable by adding spaces
...
def registerSampleData():
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        category='point_marking',
        sampleName='point_marking1',
        # Thumbnail should have size of approximately 260x280 pixels and stored in Resources/Icons folder.
        # It can be created by Screen Capture module, "Capture all views" option enabled, "Number of images" set to "Single".
        thumbnailFileName=os.path.join(iconsPath, 'point_marking1.png'),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
        fileNames='point_marking1.nrrd',
        # Checksum to ensure file integrity. Can be computed by this command:
        #  import hashlib; print(hashlib.sha256(open(filename, "rb").read()).hexdigest())
        checksums='SHA256:998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95',
        # This node name will be used when the data set is loaded
        nodeNames='point_marking1'
    )
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        # Category and sample name displayed in Sample Data module
        category='point_marking',
        sampleName='point_marking2',
        thumbnailFileName=os.path.join(iconsPath, 'point_marking2.png'),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
        fileNames='point_marking2.nrrd',
        checksums='SHA256:1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97',
        # This node name will be used when the data set is loaded
        nodeNames='point_marking2'
    )
...
class point_markingWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self):
        ...
        uiWidget = slicer.util.loadUI(self.resourcePath('UI/point_marking.ui'))
...
class point_markingLogic(ScriptedLoadableModuleLogic):
    ...
    def ijk_to_ras(self,list):
        volumeNode = slicer.util.getNode('LabelMapVolume')
    ...
    def process(self, inputVolume, outputVolume, imageThreshold, invert=False, showResult=True):
        ...
        a = slicer.util.arrayFromVolume(slicer.util.getNode('LabelMapVolume'))
        p = np.shape(a)[0]
        q = np.shape(a)[1]
        r = np.shape(a)[2]
        d1 = p//18
...
class point_markingTest(ScriptedLoadableModuleTest):
    """
    ...
    def runTest(self):
        ...
        """
        self.setUp()
        self.test_point_marking1()

    def test_point_marking1(self):
        ...
        import SampleData
        registerSampleData()
        inputVolume = SampleData.downloadSample('point_marking1')
